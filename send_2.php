...
// ENVIO DE MAIL DE NOTIFICACION
	...
	$subject = 'Landing Contactenos de ' . $form_name;

	$headers = "From:Landing Contactenos <".$form_email.">\r\n";
	...
	$message .= "<tr><td><strong>Nombre y apellido:</strong> </td><td>" . strip_tags($form_name) . "</td></tr>";
	...
	$subject2 = 'Landing Contactenos de Arloeyx';

	$headers2 = "From:Landing Contactenos <info@arloeyx.com.ar>\r\n";
