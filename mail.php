...
// ENVIO DE MAIL DE NOTIFICACION
	...
	$to = 'reservas@arloeyx.com.ar';

	$subject = 'Reserva Formulario web de ' . $form_name;

//	$headers = "From:Reserva Formulario Web <info@arloeyx.com.ar>\r\n";
	$headers = "From: Reserva Formulario Web <".$form_email.">\r\n";
	$headers .= "CC: info@arloeyx.com.ar\r\n";
	...
	// $message2 .= "</table>";
	// $message2 .= "</body></html>";
	$message2 = '<html><body><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="font-family:Helvetica, Arial, sans-serif;color:#272626"><tr><td><img src="http://alejandromarsico.com.ar/arloeyx/misc/mails/06-newsContacto/img-ctaCte.jpg" style="display:block;border:none;outline:none" width="600" height="205" /></td></tr><tr><td><table width="600" border="0" cellspacing="0" cellpadding="0"><tr height="45"><td width="50px">&nbsp;</td>';
	$message2 .= '<td style="font-size:20px">Estimado, <strong>'. strip_tags($form_name) .'</strong></td><td width="50px">&nbsp;</td></tr><tr height="30">
            <td>&nbsp;</td><td>Hemos recibido su consulta<br /> Estamos procesando su solicitud, a la brevedad recibir&aacute; un pr&oacute;ximo contacto nuestro.</td> <td >&nbsp;</td> </tr><tr height="40px"><td>&nbsp;</td><td>&nbsp;</td><td width="50px">&nbsp;</td></tr></table></td></tr><tr style="background:#e2e2e2"><td><table width="600" border="0" cellspacing="0" cellpadding="0"><tr><td colspan="3" height="40"></td></tr><tr><td width="50">&nbsp;</td><td height="47"><img src="http://alejandromarsico.com.ar/arloeyx/misc/mails/06-newsContacto/img-barComunicate.jpg" style="display:block;border:none;outline:none" width="500" height="47" /></td><td width="50">&nbsp;</td></tr><tr height="20"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td><p style="font-size:10px;padding:20px;text-align:center;border:1px solid #cdcdcd">Para seguir en contacto te solicitamos que al correo que envies nos pongas <strong>responder</strong> y podremos seguir mas presonalizadamente tu servicio.<br />Si logras conseguir un presupuesto mejor que el nuestro, te proponemos que nos envies la cotizacion formulada por la otra empresa y <strong>te mejoraremos nuestra oferta</strong>.</p></td><td>&nbsp;</td></tr><tr height="30"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td><a href="http://www.arloeyx.com.ar" target="_blank"><img src="http://alejandromarsico.com.ar/arloeyx/misc/mails/06-newsContacto/img-clubarlo.jpg" style="display:block;border:none;outline:none" width="500" height="108" /></a></td><td>&nbsp;</td></tr><tr height="20"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>&nbsp;</td><td><img src="http://alejandromarsico.com.ar/arloeyx/misc/mails/06-newsContacto/footer.jpg" style="display:block;border:none;outline:none" width="500" height="80" /></td><td>&nbsp;</td></tr></table> </td></tr></table></body></html>';
